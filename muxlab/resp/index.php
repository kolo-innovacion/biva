          ...
          <div class="container col-md-12" style="border: 3px solid ; border-radius: 5px; border-color: rgb(0,157,224); text-align: center;">
            <div class="row">
              ...
              <div class="container col-md-3">
                ...
                <img src="img/display.png" alt="" class="col-md-12">
                <input class="form-check-input position-static" type="checkbox" id="vigilancia1" value="00-0B-78-00-9A-D2" name="vigilancia1">
              </div>
              <div class="container col-md-3">
                <h6>VIGILANCIA 2</h6>
                ...
                <img src="img/display.png" alt="" class="col-md-12">
                <input class="form-check-input position-static" type="checkbox" id="vigilancia2" value="00-0B-78-00-9A-B1" name="vigilancia2">
              </div>
            </div>
            <div class="row">
              <div class="container col-md-3">
